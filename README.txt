...
Au lancement, sélectionnez le fichier à transformer en cliquant sur le bouton "Parcourir".
Attention uniquement un fichier au format .csv peut être utilisé.
...
En cas d'erreur, une nouvelle fenêtre s'ouvre avec une ligne d'explication et le choix d'arrêter l'exécution ou la continuer en ignorant l'erreur.
...
https://github.com/Plinz/PayPlug_Auzou
